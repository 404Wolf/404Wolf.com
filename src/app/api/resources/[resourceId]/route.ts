...
export async function GET(req: NextRequest, { params: { resourceId } }: { params: { resourceId: string } }) {
    ...
    return NextResponse.json(
        { status: "Success", resource: { ...resource, data: data, encoding: encoding } }
    )
}

export async function POST(req: NextRequest, { params: { resourceId } }: { params: { resourceId: string } }) {
...
export async function DELETE(req: NextRequest, { params: { resourceId } }: { params: { resourceId: string } }) {
    const resource = await prisma.resource.findUnique({
        where: {
            id: resourceId,
        },
...
export async function PUT(req: NextRequest, { params: { resourceId } }: { params: { resourceId: string } }) {
    const resource = await prisma.resource.findUnique({
        where: {
            id: resourceId,
        },
