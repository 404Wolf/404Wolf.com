...
const Project = ( { id, name, cover, date, page, isDummy=false } ) => {
    return (
        <Link href={ page || "/" } className={isDummy ? "pointer-events-none" : ""}>
            <div className="bg-cover rounded-xl drop-shadow-md hover:brightness-90 ease-in transition-all p-2 relative h-24 bg-cover bg-center duration-100 hover:scale-105 flex items-center justify-center bg-gray-100/[35%]" style={ {backgroundImage: `url('${cover}')`} }>
