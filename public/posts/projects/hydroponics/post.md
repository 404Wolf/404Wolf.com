...
![Strawberry Fruit](strawberries.webp|width=5)
...
![Hydroponic vertical grow tower](hydroponic_grow_tower.webp|width=7)
...
![Baby plants](baby_pepper.webp|width=10)
![Early growth](early_growth.webp|width=10)
![Pruning basil](pruning_basil.webp|width=12)
...
![Pesto-packed freezer](frozen_pesto.webp|width=10)
![A harvest](a_harvest.webp|width=10)
![Bowl of pesto](pesto_bowl.webp|width=11|clear=both)
