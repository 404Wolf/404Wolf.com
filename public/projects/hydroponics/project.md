...
![Baby plants](baby_pepper.webp|float=right)
![Early growth](early_growth.webp|float=right)
...
![Pesto-packed freezer](frozen_pesto.webp|width=10|float=right)
![A harvest](a_harvest.webp|width=10|float=right)
![Bowl of pesto](pesto_bowl.webp|width=11|float=left)
